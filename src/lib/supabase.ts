...
export const getRedirectURL = () => {
  ...
  // For server-side rendering, check if we're in production
  if (process.env.NODE_ENV === 'production') {
    // TODO: Replace this with your actual Vercel app URL
    return 'https://medication-reminder-app-4b7w.vercel.app'
  }
...
export const signUpWithRedirect = async (email: string, password: string, metadata?: any) => {
  console.log('🔗 Sign up redirect URL:', getRedirectURL())
